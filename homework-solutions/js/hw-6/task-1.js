...
const secondNumberArray = [3, 11, 32, 7, 20];
const [first, second, ...rest] = secondNumberArray;
...
const thirdNumberArray = [1,2,3,4,5];
const anotherNumberArray = [6, 7, 8, 9, 10];

const mergedArray = [...thirdNumberArray, ...anotherNumberArray];
